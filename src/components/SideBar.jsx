    ...
    return (
        <div className = {`flex flex-col text-white bg-dukaan-side-bar-blue top-0 left-0 duration-300 ease-in-out ${
            ...
            <div className="text-sm">
                <div className="flex py-2 hover:bg-gray-700 pl-4 mx-2 mt-1 rounded-sm">
